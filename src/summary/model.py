...
class BaseModel(object):
    ...
    def __init__(self,
        ...
        res = self.build_graph(hparams, scope=scope)  # (logits, loss, final_context_state)
    ...
    def _build_decoder(self, encoder_outputs, encoder_state, hparams):
        ...
        with tf.variable_scope("decoder") as decoder_scope:
            # abstract method, different decoer model must implement their self decoder rnn cells
