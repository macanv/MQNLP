...
from src.summary import attention_model
from src.summary import model_helper
...
class GNMTModel(attention_model.AttentionModel):
    ...
    def _build_decoder_cell(self, hparams, encoder_outputs, encoder_state,
        ...
        if self.time_major:  # TODO: 没明白
            memory = tf.transpose(encoder_outputs, [1, 0, 2])
        else:
            memory = encoder_outputs

        # 如果是train 过程，并且beam serach 的参数大于0, 获取相关tensor的维度
        ...
        # 获取分配好训练GPU的RNN cell list, list 中RNN cell 的个数和num_layers 层数相同
