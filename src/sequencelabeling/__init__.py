...
# flags.DEFINE_string("ckpt_path",    "../models/ner",      "Path to save model")
# flags.DEFINE_string("summary_path", "summary",      "Path to store summaries")
# flags.DEFINE_string("log_file",     "../models/ner/train.log",    "File for log")
# flags.DEFINE_string("map_file",     "../models/ner/maps.pkl",     "file for maps")
# flags.DEFINE_string("vocab_file",   "../models/ner/vocab.json",   "File for vocab")
# flags.DEFINE_string("config_file",  "../models/ner/config_file",  "File for config")
# flags.DEFINE_string("script",       "../../dataset/ner/conlleval",    "evaluation script")
# flags.DEFINE_string("result_path",  "../models/ner/result",       "Path for results")
#
# flags.DEFINE_string("emb_file", r'../../dataset/ner/wiki_100.utf8',  "Path for pre_trained embedding")
# flags.DEFINE_string("train_file", r'../../dataset/ner/example.train',  "Path for train data")
# flags.DEFINE_string("dev_file", r'../../dataset/ner/example.dev',    "Path for dev data")
# flags.DEFINE_string("test_file", r'../../dataset/ner/example.test',   "Path for test data")
#
