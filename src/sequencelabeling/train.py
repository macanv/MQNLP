...
tf.flags.DEFINE_integer("lstm_dim", 100, "Num of hidden units in LSTM, or num of filters in IDCNN")
tf.flags.DEFINE_string("tag_schema", "iobes", "tagging schema iobes or iob")
tf.flags.DEFINE_integer("num_segs", 4, "Number of sges")
...
tf.flags.DEFINE_boolean("pre_emb", True, "Wither use pre-trained embedding")
tf.flags.DEFINE_boolean("zeros", False, "Wither replace digits with zero")
tf.flags.DEFINE_boolean("lower", True, "Wither lower case")
...
tf.flags.DEFINE_string("ckpt_path", "../models/ner", "Path to save model")
tf.flags.DEFINE_string("summary_path", "summary", "Path to store summaries")
tf.flags.DEFINE_string("log_file", "../models/ner/train.log", "File for log")
tf.flags.DEFINE_string("map_file", "../models/ner/maps.pkl", "file for maps")
tf.flags.DEFINE_string("vocab_file", "../models/ner/vocab.json", "File for vocab")
tf.flags.DEFINE_string("config_file", "../models/ner/config_file", "File for config")
tf.flags.DEFINE_string("script", "../../dataset/ner/conlleval", "evaluation script")
tf.flags.DEFINE_string("result_path", "../models/ner/result", "Path for results")
